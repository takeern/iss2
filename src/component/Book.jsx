            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div>We sincerely invite distinguished scholars from all over the world to deliver your manuscript and publish you excellent work. Please contact 
                        <a href='mailto:book@bryanhousepub.org' style={{ fontWeight: 700, }}> book@bryanhousepub.org</a> if you want to publish a book or have any questions about book publication.</div>
                </div>
            </div>
